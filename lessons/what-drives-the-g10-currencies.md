...
Jump to a currency: [USD](#usd) · [EUR](#eur) · [JPY](#jpy) · [GBP](#gbp) · [CHF](#chf) · [CAD](#cad) · [AUD](#aud) · [NZD](#nzd) · [NOK](#nok) · [SEK](#sek).
...
## What Drives the US Dollar (USD)? {#usd}
...
## What Drives the Japanese Yen (JPY)? {#jpy}
...
## What Drives the British Pound (GBP)? {#gbp}
...
## What Drives the Swiss Franc (CHF)? {#chf}
...
## What Drives the Canadian Dollar (CAD)? {#cad}
...
## What Drives the Australian Dollar (AUD)? {#aud}
...
## What Drives the New Zealand Dollar (NZD)? {#nzd}
...
## What Drives the Norwegian Krone (NOK)? {#nok}
...
## What Drives the Swedish Krona (SEK)? {#sek}
...
1. **What's driving currency A right now?** Which of its drivers is dominant this week?
2. **What's driving currency B?**
3. **Which story is stronger — and is the market behaving consistently with that?**
...
:::flow
Currency Drivers → Expectations → Currency Strength → Relative Strength → FX Pair
:::
