...
title: Why Some Economic Data Moves Markets — And Some Doesn't
...
:::flow
Actual → Expected → Surprise → What Changes → Market Confirmation
:::
...
:::insight
The market is not starting from zero. It is starting from a prediction.
:::
...
This lesson is part of the FXStrength Learning Path. For more on how markets price expectations, read [Lesson #001 — Markets Trade Expectations](/behind-the-move/why-aud-fell-after-cpi).
